...
- 可按词典、文件夹、标签、当前笔记，或所选文件的直接双链复习；内容可选整篇笔记、语法卡或两者
- 多挖空卡可当场选择显示一个或全部答案，也可搁置卡片而不删除笔记或高亮
- 到期/新词统计、复习热力图、撤销和跳过
- 高亮随记忆稳定度提高而渐隐
...
1. 下载 [Chrome 版 Lexis Web 1.2.3](https://github.com/Heptazero/obsidian-lexis/releases/download/browser-v1.2.3/lexis-web-1.2.3.zip)或 [Firefox 版 Lexis Web 1.2.3](https://github.com/Heptazero/obsidian-lexis/releases/download/browser-v1.2.3/lexis-web-firefox-1.2.3.zip)，然后解压。
